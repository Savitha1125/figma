    ...
    ">
      ...
      <div>
        ...
        <button
          ...
          className={`
      absolute top-[46%] right-0 transform -translate-y-1/2
      bg-[#F47422] text-white px-3 py-3 font-semibold
      transition-all duration-300 z-100
      ${open ? "right-80" : "right-0"}  /* moves button when form opens */
      writing-vertical-lr text-center rotate-180 h-50 rounded-r-xl
    `}
        ...
        <div
          className={`
       top-[58%] right-0 transform -translate-y-1/2
      bg-white shadow-lg p-6 rounded-lg w-80
      transition-all duration-300 z-100
      ${open ? "translate-x-0 absolute" : "translate-x-full hidden"}  /* slide form from right */
    `}
        >
          {/* Close Icon */}
          <button
