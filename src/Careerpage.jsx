    ...
    return (
        <div className="mt-40 relative">
            <img
                src={leftImg}
                alt="left corner"
                className="absolute top-10 left-0 w-20 sm:w-48 md:w-24 lg:w-20 pointer-events-none opacity-60"
            />
            <img
                src={rightImg}
                alt="right corner"
                className="absolute top-80 right-0 w-20 sm:w-10 md:w-14 lg:w-25 pointer-events-none opacity-60"
            />
            
            <div className="my-20 text-center max-w-6xl mx-auto flex flex-col gap-6">
                <div className="text-center text-4xl text-[#19467E] font-semibold mt-10">
